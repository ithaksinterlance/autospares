      ...
      <div>
        ...
        <div className="container py-5">
          ...
          <div className="col-md-6">
              ...
              <h1 className="paragraph">car battery replacement dubai,car battery replacement sharjah, car battery sharjah, bmw battery replacement dubai , car battery change, battery replacement sharjah ,  car battery replacement , car battery shop sharjah, car battery price dubai, solite battery price in uae ,  car battery replacement near me, amaron battery dubai, car battery change dubai, battery change dubai ,  car battery price ,  battery replacement dubai , amaron car battery , amaron battery, Car Battery change Dubai, Car battery service near me, Car battery recharging shop near me, Car battery charging, Car battery mechanic near me, Car battery service near me, BMW car battery replacement, Mercedes Car battery replacement,
    Kia battery replacement, Kia Battery change, Kia Battery charging, BMW car battery change, BMW car battery change, Mercedes car battery change, Mercedes car battery change, Audi car battery replacement Service, Audi car battery change, Audi car battery charging, Honda car battery replacement, Honda car battery change,
    Honda car battery charging service, Lexus car battery replacement, Lexus car battery recharge, Lexus car battery change, Nissan car battery replacement, Nissan car battery change, Nissan car battery  recharge, ford car battery replacement service, Nissan car battery change, Nissan car battery recharging service,
    Mitsubishi car battery replacement, Mitsubishi car battery service, Mitsubishi car battery change, AMARON car battery service, AMARON car battery replacement, AMARON car battery change, AMARON car battery shop, Acdelco car battery replacement, Acdelco car battery service, Acdelco car battery change, Acdelco car battery charging,  Varta car battery replacement, Varta car battery service, Varta car battery change, Varta car battery charging,
    solite car battery service, solite car battery replacement, solite car battery change, solite car battery recharge, car battery service Sharjah,Car battery change Sharjah, dial a battery, 800 battery dubai, onsite car battery, Camry battery replacement dubai, Corolla Battery replacement dubai, Elantra Battery replacement dubai, Chevrolet battery replacement dubai, Accord battery replacement dubai, altima battery replacement dubai, sunny battery replacement dubai, land cruiser battery replacement dubai, yaris battery replacement dubai, sentra battery replacement dubai, prado battery replacement dubai,alfa romeo battery replacement dubai, honda battery replacement dubai, bentley battery replacement dubai,Bugatti battery replacement dubai, cadillac battery replacement dubai,Chrysler battery replacement dubai, citron battery replacement dubai ,Daihatsu battery replacement dubai, dodge battery replacement dubai, ferrari battery replacement dubai, fiat battery replacement dubai, ford battery replacement dubai, gmc battery replacement dubai, great wall battery replacement dubai, hummer battery replacement dubai, hyundai battery replacement dubai, isuzu battery replacement dubai, infiniti battery replacement dubai, jaguar battery replacement dubai, jeep battery replacement dubai, kia battery replacement dubai, lamborghini battery replacement dubai,   onsite battery Sharjah, replace battery car, Camry battery replacement sharjah, Corolla Battery replacement sharjah, Elantra Battery replacement sharjah, Chevrolet battery replacement sharjah, Accord battery replacement sharjah, altima battery replacement sharjah, sunny battery replacement sharjah, land cruiser battery replacement sharjah, yaris battery replacement sharjah, sentra battery replacement sharjah, prado battery replacement sharjah,alfa romeo battery replacement sharjah, honda battery replacement sharjah, bentley battery replacement sharjah,Bugatti battery replacement sharjah, cadillac battery replacement sharjah,Chrysler battery replacement sharjah, citron battery replacement sharjah ,Daihatsu battery replacement sharjah, dodge battery replacement sharjah, ferrari battery replacement sharjah, fiat battery replacement sharjah, ford battery replacement sharjah, gmc battery replacement sharjah, great wall battery replacement sharjah, hummer battery replacement sharjah, hyundai battery replacement sharjah, isuzu battery replacement sharjah, infiniti battery replacement sharjah, jaguar battery replacement sharjah, jeep battery replacement sharjah, kia battery replacement sharjah, lamborghini battery replacement sharjah</h1>
            </div>
            <div className="col-md-6">
